...
My Orcid iD is [0000-0002-5029-1892](https://orcid.org/0000-0002-5029-1892)

[My Google Scholar Profile](https://scholar.google.com/citations?user=Ui4ulbcAAAAJ&hl=en&oi=ao)     
[My Resarch Gate Profile](https://www.researchgate.net/profile/Monica-Reggiani)
...
for _, data in yaml_data.items():
    ...
    authors = [aut if aut != "me" else "<strong>Monica Reggiani</strong>" for aut in authors]
    ...
    if working_paper:
        ...
        buttons.append(button(pub_url, "Published", "bi-book"))
